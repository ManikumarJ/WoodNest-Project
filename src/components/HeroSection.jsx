    ...
    <section className="bg-[#F5F5F5] ">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center px-6 py-20 gap-10">
        ...
        <div className="flex-1 flex flex-col gap-6">
          <h2 className="text-4xl md:text-5xl font-bold text-[#0F2A1D] leading-snug">Furnisia – Luxury Furniture for Your Home</h2>
          ...
          <button className="w-40 hover:bg-[#9AE6B4] hover:text-[#0F2A1D] px-6 py-3 rounded-lg font-semibold bg-[#064232] text-white transition">
            Shop Now
          </button>
